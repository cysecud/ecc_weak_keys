...
impl ImplicitP256k1{
    pub const DIVISOR_32:[&'static str; 1]=["18051648"];
    pub const DIVISOR_64:[&'static str; 4]=["18051648", "6871154804262114368","10306732206393171552", "15996907278672735013"];
    pub const DIVISOR_128:[&'static str;8]=["1938057310625759192294976", "3154049060501396119538597952", "9782462315356940942943205974373470912", "41427743093894159295282972951876913728", "192897928780944679218661342807176879546", "225103679124018650938499972290963477356", "257197238374592905624881790409569172728", "300138238832024867917999963054617969808"];
    pub const DIVISOR_160:[&'static str;2]=["6172733720990229734997162969829660145472", "338624364920977752681389262317185522840540224"];
...
impl <'a>FieldElement<'a,U256> for ImplicitP256k1{
    const PRIME:&'a str ="115792089237316195423570985008687907852837564279074904382605163141518161494337";
    ...
    fn prime()->U256 {
        U256::from_dec_str(Self::PRIME).expect("error in Prime Field 256")
    }
